...
skills <- tribble(
  ...
  "Version Control", "Git",
  "Text Editors", "RStudio, Visual Studio, ",
...
edu <- tribble(
  ...
  "Missouri University of Science and Technology", 2017, NA, "Ph.D. Mathematics (Statistics Emphasis)", "Rolla, MO ",NA,
  "University of New Orleans", 2015, 2017, "M.S. Mathematics ", "New Orleans",NA,
